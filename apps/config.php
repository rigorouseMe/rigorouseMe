...
return [
    ...
    'url_html_suffix'        => URL_HTML_SUFFIX,// URL伪静态后缀
    ...
    'template'               => [
        ...
        'view_suffix'  => VIEW_SUFFIX,// 模板后缀
        'view_depr'    => VIEW_DERP,// 模板文件名分隔符
    ...
    // +----------------------------------------------------------------------
    'cookie'                 => [
        'prefix'    => 'MI_C_',// cookie 名称前缀
        'expire'    => 0,// cookie 保存时间
        'path'      => '/',// cookie 保存路径
        'domain'    => BASE_URL,// cookie 有效域名
